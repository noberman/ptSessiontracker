...
import type { AppointmentConfirmationEmailData } from '../types'
import type { CSSProperties } from 'react'
import { format } from 'date-fns'
import { toZonedTime } from 'date-fns-tz'

export const AppointmentConfirmationEmail: React.FC<AppointmentConfirmationEmailData> = ({
  recipientName,
  appointmentType,
  scheduledAt,
  duration,
  ...
  return (
    <BaseEmailTemplate
      preview={`Your ${typeLabel.toLowerCase()} with ${trainerName} has been confirmed`}
    >
      ...
      <Section style={detailBox}>
        ...
        {notes && (
          <Row style={detailRow}>
            ...
            <Column style={detailValue}>{notes}</Column>
          </Row>
        )}
      </Section>
